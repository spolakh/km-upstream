  ...
  patterns: [
    {
      ...
      example: {
        ...
        code: [
          ...
          "  getPluginPrefsBlock, INFRASTRUCTURE_TYPE_DISPLAY, typesFacet, propertySchemasFacet,",
    ...
    },
    {
      ...
      example: {
        ...
        code: [
          ...
          "  getPluginPrefsBlock, INFRASTRUCTURE_TYPE_DISPLAY, propertyEditorOverridesFacet,",
          ...
          "  id: 'readwise-prefs',",
          "  label: 'Readwise',",
          "  ...INFRASTRUCTURE_TYPE_DISPLAY, // plumbing, not a tag",
